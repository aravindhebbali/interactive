...
Click 'Run Code'. The data from the built-in example data frame `mtcars` will be printed to the console.

```{r df1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Matrix'}
...
```{r df2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Matrix'}
# Call head() on mtcars
...
```{r df3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Matrix'}
...
```{r df4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Matrix'}
...
# print first five rows of planets_df
planets_df
...
```{r df5, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Matrix'}
# Definition of vectors
name <- c("Mercury", "Venus", "Earth", "Mars", "Jupiter", "Saturn", "Uranus", "Neptune")
type <- c("Terrestrial planet", "Terrestrial planet", "Terrestrial planet", 
          "Terrestrial planet", "Gas giant", "Gas giant", "Gas giant", "Gas giant")
...
```{r df6, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Matrix'}
# Definition of vectors
name <- c("Mercury", "Venus", "Earth", "Mars", "Jupiter", "Saturn", "Uranus", "Neptune")
type <- c("Terrestrial planet", "Terrestrial planet", "Terrestrial planet", 
          "Terrestrial planet", "Gas giant", "Gas giant", "Gas giant", "Gas giant")
...
```{r df7, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Matrix'}
# Definition of vectors
name <- c("Mercury", "Venus", "Earth", "Mars", "Jupiter", "Saturn", "Uranus", "Neptune")
type <- c("Terrestrial planet", "Terrestrial planet", "Terrestrial planet", 
          "Terrestrial planet", "Gas giant", "Gas giant", "Gas giant", "Gas giant")
...
```{r df8, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Matrix'}
# Definition of vectors
name <- c("Mercury", "Venus", "Earth", "Mars", "Jupiter", "Saturn", "Uranus", "Neptune")
type <- c("Terrestrial planet", "Terrestrial planet", "Terrestrial planet", 
          "Terrestrial planet", "Gas giant", "Gas giant", "Gas giant", "Gas giant")
...
```{r df9, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Matrix'}
# Definition of vectors
name <- c("Mercury", "Venus", "Earth", "Mars", "Jupiter", "Saturn", "Uranus", "Neptune")
type <- c("Terrestrial planet", "Terrestrial planet", "Terrestrial planet", 
          "Terrestrial planet", "Gas giant", "Gas giant", "Gas giant", "Gas giant")
...
```{r df10, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Matrix'}
# Definition of vectors
name <- c("Mercury", "Venus", "Earth", "Mars", "Jupiter", "Saturn", "Uranus", "Neptune")
type <- c("Terrestrial planet", "Terrestrial planet", "Terrestrial planet", 
          "Terrestrial planet", "Gas giant", "Gas giant", "Gas giant", "Gas giant")
...
Experiment with the `order()` function in the console. Click 'Run Code' when you are ready to continue.

```{r df11, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Matrix'}
# Play around with the order function in the console

```

## Sorting Data Frames - 2
...
```{r df12, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Matrix'}
# Definition of vectors
name <- c("Mercury", "Venus", "Earth", "Mars", "Jupiter", "Saturn", "Uranus", "Neptune")
type <- c("Terrestrial planet", "Terrestrial planet", "Terrestrial planet", 
          "Terrestrial planet", "Gas giant", "Gas giant", "Gas giant", "Gas giant")
