...
```{r factor1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Matrix'}
# Gender vector
gender_vector <- c("Male", "Female", "Female", "Male", "Male")
...
- Click 'Run Code' to check how R constructs and prints nominal and ordinal variables. Do not worry if you do not understand all the code just yet, we will get to that.

```{r factor2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Matrix'}
# Animals
...
```{r factor3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Matrix'}
...
```{r factor4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Matrix'}
...
- Read the code in the editor and click 'Run Code' to see whether males are worth more than females.

```{r factor5, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Matrix'}
# Build factor_survey_vector with clean levels
survey_vector <- c("M", "F", "F", "M", "M")
factor_survey_vector <- factor(survey_vector)
levels(factor_survey_vector) <- c("Female", "Male")
...
```{r factor6, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Matrix'}
# Create speed_vector
speed_vector <- 

# print out speed_vector
speed_vector
...
```{r factor7, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Matrix'}
# Create speed_vector
speed_vector <- c("fast", "slow", "slow", "fast", "insane")
...
```{r factor8, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Matrix'}
